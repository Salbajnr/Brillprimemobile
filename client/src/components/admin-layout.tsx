...
export function AdminLayout({ children, currentPage, onPageChange }: AdminLayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'KYC Verification', page: 'kyc', icon: '✅' },
    { name: 'Merchant Applications', page: 'merchants', icon: '🏪' },
    { name: 'Driver Applications', page: 'drivers', icon: '🚗' },
    { name: 'Support Tickets', page: 'support', icon: '🎫' },
    { name: 'Transactions', page: 'transactions', icon: '💰' },
    { name: 'Fraud Detection', page: 'fraud', icon: '🚨' },
    { name: 'Real-time Monitoring', page: 'monitoring', icon: '📡' },
    { name: 'Security & Compliance', page: 'security', icon: '🔒' },
    { name: 'System Maintenance', page: 'maintenance', icon: '⚙️' },
  ];
